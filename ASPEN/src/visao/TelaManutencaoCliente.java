...
public class TelaManutencaoCliente extends javax.swing.JDialog {
    ...
    private void atualizarTabela()
    {
        ...
        listClientes.clear();
        listClientes.addAll(controle.getPorNome(txtPesquisar.getText()));
        
        for(Cliente c : listClientes)
        {
            modelo.addRow(new Object[]{c.getCodigo(), c.getCpf(), 
                c.getNome(), c.getCep()});
        }   
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manutenção Cliente");
    ...
    private void botAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAlterarActionPerformed
        ...
        if (linha == -1)
        {
            JOptionPane.showMessageDialog(null, 
                    "Não foi selecionado nenhum cliente. Selecione.");
        }
        else
        {
            TelaDadosCliente tela = new TelaDadosCliente(null, true);
